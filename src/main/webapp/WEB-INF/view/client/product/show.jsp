                                ...
                                <div>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">List of products
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="row g-4">
                                            ...
                                            <div class="col-12" id="targetFilter">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-4"
                                                        value="MONG-NHE">
                                                    <label class="form-check-label" for="target-4">Slim and
                                                        light</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                            ...
                                            <div class="col-12" id="priceFilter">
                                                <div class="mb-2"><b>Pricing</b></div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="price-2"
                                                        value="duoi-10-trieu">
                                                    <label class="form-check-label" for="price-2">Less than 10
                                                        million</label>
                                                </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label" for="sort-1">Rising price</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" id="sort-2"
                                                        value="gia-giam-dan" name="radio-sort">
                                                    <label class="form-check-label" for="sort-2">Declining
                                                        price</label>
                                                </div>
